...
function Owner({ setIsLoggedIn }){
  ...
  const submitHandler= async (event)=>{
    ...
    await axios.post('http://localhost:8000/owner-signup',formData)
    .then (res => {
...
return (
  ...
  <MDBCard className="my-4 ">
    ...
    <h6 className=" mx-4 my-2" style={{backgroundColor:"yellow"}}><sub className="sub1">*</sub><sub className="sub1">*</sub><sub className="sub1">*</sub> 
            <Link to ='/non-registered-pg'>You have not yet Registered your pg / HomeStay pls click on this </Link> 
            <sub className="sub1">*</sub> <sub className="sub1">*</sub> <sub className="sub1">*</sub> </h6>
    ...
    <MDBCardBody className="p-5">
     <MDBRow>
      ...
      <MDBCol col="6">
        <p>
         Property Registration Number <sub className="sub1">*</sub>
        </p>
